      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="text-right">
             <a href="<?php echo site_url('admin_datanilai/export_excel') ?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-print m-r-5"></i> Export Hasil Nilai</a>
            <a href="<?php echo site_url('admin_datanilai/print_nilai') ?>" class="btn btn-success waves-effect waves-light"><i class="fa fa-print m-r-5"></i> Cetak Hasil Nilai</a>
                    </div>
        </div>
        <div class="card-body">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="laporan" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="seminar" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>                                              
                    </div>
