...
foreach ($get as $get): ?>
                  <tr>
                    ...
                    <td align="center"><?php echo $get['afektif'] ?></td>
                    <td align="center"><?php echo $get['kognitif'] ?></td>
                    <td align="center"><?php echo $get['psikomotor'] ?></td>
                    
                    <td align="center"><?php $total = $get['afektif']+$get['kognitif']+$get['psikomotor']; ?>
                        <?php echo $total ?></td>
                  </tr>
                  <?php endforeach;?>                           
                </tbody>
