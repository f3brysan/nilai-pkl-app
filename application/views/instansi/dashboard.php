        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?php echo site_url('instansi_datanilai') ?>" class="small-box-footer">Enter  <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        ...
        <div class="col-md-12">
          <div class="card-box">
            ...
            <ul class="nav nav-pills navtab-bg nav-justified pull-in ">
              ...
              <li class="nav-item">
                <a href="#nilai" data-toggle="tab" aria-expanded="false" class="nav-link">
                                                <i class="fi-mail mr-2"></i> Penilaian
                                            </a>
              </li>
            </ul>
            <div class="tab-content">
              ...
              <div class="tab-pane" id="nilai">
                <h5>Range Penilaian</h5>                
                <p>Range Nilai Afektif : 15 - 25.</p>
                <p>Range Nilai Kognitif : 30 - 40.</p>
                <p>Range Nilai Psikomotor : 20 - 35.</p>
                <p>Total Nilai :</p>
                <li>76 - 100 = A (4.00)</li>     
                <li>66 - 75 = B (3.00)</li> 
                <li>65 - 75 = B (3.00)</li>        
