                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="lh_afektif" placeholder="" id="afektif" class="form-control" type="number" maxlength="3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="lh_kognitif" placeholder="" id="kognitif" class="form-control" type="number" maxlength="3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="lh_psikomotor" placeholder="" id="psikomotor" class="form-control" type="number" maxlength="3">
